...
![640?wx_fmt=other](https://img-blog.csdnimg.cn/img_convert/2bda69e785210f4ce88f3a24a3e54182.png)
...
![640?wx_fmt=other](https://img-blog.csdnimg.cn/img_convert/a7be6e3f7660ecca0c9f08e4353dab9c.png)

不能保证两个 List 具有相同的元素类型的情况

```
GlmapperGeneric<String> glmapperGeneric = new GlmapperGeneric<>();	List<String> dest = new ArrayList<>();	
List<Number> src = new ArrayList<>();	glmapperGeneric.testNon(dest,src);
```
...
![640?wx_fmt=other](https://img-blog.csdnimg.cn/img_convert/c41f4c3c9a61b159069fe481ff0a5063.png)
...
![640?wx_fmt=other](https://img-blog.csdnimg.cn/img_convert/3b9e92d744bb05fa9cfd2dff7ce0ea38.png)
...
![640?wx_fmt=other](https://img-blog.csdnimg.cn/img_convert/d952c11af620f81c7a8b1b87f59fdae1.png)

那如果也想 `publicClass<T>clazzT;` 这样的话，就必须让当前的类也指定 T ，

```
public class Test3<T> {	   
    public Class<?> clazz;	    // 不会报错	    
    public Class<T> clazzT;	
}
```
